<div class="row">
    <div class="col-md-6">
        <h4>
        Projet de groupe Génie logiciel - groupe 3 IOTIA
        </h4>
        <br>
        <h6>2019 / 2020</h6>
    </div>
    ...
    <div class="col-md-6">
            <h4>Notre Dépot git : </h4>
            <a href="https://git-iutinfo.unice.fr/gr817429/gl2020-iotia-lp-iotia---groupe-3">
            <span class="a-link">Groupe 3</span>
        </a>
    </div>
</div>

<!-- <script defer type="text/javascript" src="../../public/js/utils.js">
 -->
 <script>
...
//var globalStyle=parseInt('<?php //echo $session_style;?>');
    var globalStyle = 1;
    <?php if (!empty($_COOKIE['cookieStyle'])) { ?>
    globalStyle = GetCookie('cookieStyle');
    <?php } ?>
    console.log("Changer le style");
    console.log(this.globalStyle);
</script>
